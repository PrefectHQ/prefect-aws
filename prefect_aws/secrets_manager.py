...
async def update_secret(
    ...
    try:
        response = await run_sync_in_worker_thread(client.update_secret, **update_secret_kwargs)
...
async def create_secret(
    ...
    try:
        response = await run_sync_in_worker_thread(client.create_secret, **create_secret_kwargs)
...
async def delete_secret(
    ...
    try:
        response = await run_sync_in_worker_thread.run_sync(client.delete_secret, **delete_secret_kwargs)
        response.pop("ResponseMetadata", None)
        return response
    except ClientError:
